...
def draw_back_button(display, background=None, foreground=None):
    """Draw a clear top-left BACK button. Tap area: x 0-67, y 0-35."""
    theme = _theme
...
def draw_tools_icon(display, x, y):
    # Toolbox body
    display.fill_rect(x + 6, y + 22, 60, 36, 0xFD20)
    display.outline_rect(x + 6, y + 22, 60, 36, WHITE, 2)
    display.fill_rect(x + 22, y + 12, 28, 12, 0xFD20)
    display.outline_rect(x + 22, y + 12, 28, 12, WHITE, 2)
    display.fill_rect(x + 31, y + 34, 10, 8, BLACK)


def draw_calculator_icon(display, x, y):
    display.fill_rect(x + 12, y + 3, 48, 62, 0x4208)
    display.outline_rect(x + 12, y + 3, 48, 62, WHITE, 2)
    display.fill_rect(x + 18, y + 9, 36, 13, BLACK)
...
def draw_clock_icon(display, x, y):
    # Square-faced clock for fast rectangle-only rendering.
    display.fill_rect(x + 10, y + 5, 52, 52, WHITE)
    display.outline_rect(x + 10, y + 5, 52, 52, CYAN, 4)
    display.fill_rect(x + 34, y + 15, 4, 19, BLACK)
    display.fill_rect(x + 36, y + 32, 15, 4, BLACK)
    display.fill_rect(x + 34, y + 31, 6, 6, 0xF800)
...
def draw_app_icon(display, name, x, y, size, background):
    ...
    if name == "FILES":
        ...
        draw_tools_icon(display, icon_x, icon_y)
    elif name == "CALCULATOR":
        draw_calculator_icon(display, icon_x, icon_y)
    elif name == "CLOCK":
        draw_clock_icon(display, icon_x, icon_y)
